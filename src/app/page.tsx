            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-5">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve explored a range of ideas—from lightweight sites to more involved applications. Here are a few that stand out.
                </p>
              </div>
            </div>
          </BlurFade>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-5">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  {DATA.hackathons.length}+ hackathons where people from across the country came together to build innovative solutions. It was eye-opening to see what passionate teams could create, and it shaped how I approach problem-solving today.
                </p>
              </div>
            </div>
          </BlurFade>
